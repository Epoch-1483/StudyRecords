...
-- Records of accident
-- ----------------------------
INSERT INTO `accident` VALUES (3, '', '524大事件', 2, '洪水', '2026-05-24 13:38:00', '重庆工程学院', NULL, NULL, 0, 10000000000.00, '洪水', '', 'OCCURRED', '系统管理员', '2026-05-24 13:39:44', '2026-05-24 13:53:28');
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '出警记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `donation`  (
  ...
  INDEX `idx_status`(`status` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '物资捐赠表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `emergency_plan`  (
  ...
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '应急处置方案表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `help_request`  (
  ...
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '求助信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of help_request
-- ----------------------------
INSERT INTO `help_request` VALUES (1, NULL, '', '', 1, '', '29.425470444375634,106.59215831761004', NULL, NULL, '', '', '已救援', NULL, NULL, '2026-05-23 20:08:41');
INSERT INTO `help_request` VALUES (2, NULL, '', '', 1, '', '未知位置', NULL, NULL, '', '', '已救援', NULL, NULL, '2026-05-23 20:23:38');
INSERT INTO `help_request` VALUES (3, NULL, '郑昌军', '15023461794', 1, '重庆工程学院（南泉校区）', '未知位置', NULL, NULL, '小孩', '需要医疗物品', '已救援', NULL, NULL, '2026-05-23 20:30:12');
INSERT INTO `help_request` VALUES (4, NULL, '张银', '', 1, '重庆工程学院', '未知位置', NULL, NULL, '', '需要食物', '已转移', NULL, NULL, '2026-05-24 11:22:58');
INSERT INTO `help_request` VALUES (5, NULL, '王磊', '', 1, '', '29.421802,106.589545', NULL, NULL, '', '', '已救援', NULL, NULL, '2026-05-24 14:08:18');
INSERT INTO `help_request` VALUES (6, NULL, '张银', '18523820765', 10086, '重庆工程学院', '29.421822,106.589514', NULL, NULL, '郑昌军', '速来', '已救援', NULL, NULL, '2026-05-24 16:05:23');
INSERT INTO `help_request` VALUES (7, NULL, '', '', 1, '无', '未知位置', NULL, NULL, '', '', '待救援', NULL, NULL, '2026-05-24 16:15:37');
INSERT INTO `help_request` VALUES (8, NULL, '苟一民', '15234679891', 1, '', '29.421824,106.589534', 29.421824, 106.589534, '老人', '', '待救援', NULL, NULL, '2026-05-24 19:48:51');
...
CREATE TABLE `message_board`  (
  ...
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '留言板表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `rescuer_application`  (
  ...
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE,
  INDEX `idx_status`(`status` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '救助员申请表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sensor_data`  (
  ...
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 129 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '传感器数据表' ROW_FORMAT = Dynamic;
